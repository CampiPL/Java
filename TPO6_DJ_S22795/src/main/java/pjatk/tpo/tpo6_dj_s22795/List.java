            ...
            throws IOException
    {
        ...
        try {
            ...
            stmt.execute("create table POZYCJE ( ISBN char(13) not null, AUTID integer not null, TYTUL" +
                    " varchar(255) not null, WYDID integer not null, ROK integer not null, CENA real," +
                    " PRIMARY KEY(ISBN), FOREIGN KEY(AUTID) REFERENCES AUTOR(AUTID), FOREIGN KEY(WYDID)" +
                    " REFERENCES WYDAWCA(WYDID))");
            ...
            rs = stmt.executeQuery("select * from pozycje");
