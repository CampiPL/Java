...
public class Tools {
    ...
    static Options createOptionsFromYaml(String fileName) throws Exception{
        ...
        options = new Options(String.valueOf(load.get("host")), Integer.parseInt(String.valueOf(load.get("port"))), (Boolean) load.get("concurMode"), (Boolean) load.get("showSendRes"), (Map<String, List<String>>) load.get("clientsMap"));
